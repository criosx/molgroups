...
tBLM::tBLM(){
	...
	bME->vol=110;
	bME->nSL=3.243e-5;
	bME->l=5.2;															     //see fnAdjustParameters for exact length of this group
	tether->vol=380;
...
void tBLM::fnAdjustParameters(){
  ...
  if ((tether->l+tetherg->l)<(headgroup2->l+bME->l)) {
      bME->l=tether->l+tetherg->l-headgroup2->l;
  }
...
//  if ((tether->l+tetherg->l)<(headgroup1->l+bME->l)) {
//      bME->l=tether->l+tetherg->l-headgroup1->l;
//  }
