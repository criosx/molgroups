 ...
 *  updated 16-Sep-2011 HC18 volume and nSL
...
void nSLDObj::fnWriteGroup2File (FILE *fp, const char *cName, int dimension, double stepsize){};
...
void tBLM_quaternary_chol_domain::fnAdjustParameters(){
    ...
    headgroup2_2->fnSetAllSigma(sigma);
    headgroup2_3->fnSetAllSigma(sigma);
    headgroup1_domain->fnSetAllSigma(sigma);
    headgroup1_2_domain->fnSetAllSigma(sigma);
    headgroup1_3_domain->fnSetAllSigma(sigma);
    lipid1_domain->fnSetAllSigma(sigma);
    methyl1_domain->fnSetAllSigma(sigma);
    methyl2_domain->fnSetAllSigma(sigma);
    lipid2_domain->fnSetAllSigma(sigma);
    headgroup2_domain->fnSetAllSigma(sigma);
    headgroup2_2_domain->fnSetAllSigma(sigma);
    headgroup2_3_domain->fnSetAllSigma(sigma);
    tether_domain->sigma1=global_rough; 
    tether_domain->sigma2=sigma;
    tetherg_domain->fnSetAllSigma(sigma); 
