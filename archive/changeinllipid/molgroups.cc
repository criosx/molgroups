...
void nSLDObj::fnWritePar2File (FILE *fp, char *cName, int dimension, double stepsize){};
...
void   BoxErr::fnWritePar2File(FILE *fp, char *cName, int dimension, double stepsize)
{
...
void   Box2Err::fnWritePar2File(FILE *fp, char *cName, int dimension, double stepsize)
{
...
void   Gaussian::fnWritePar2File(FILE *fp, char *cName, int dimension, double stepsize)
{
...
void   Parabolic::fnWritePar2File(FILE *fp, char *cName, int dimension, double stepsize)
{
...
void   StretchGaussian::fnWritePar2File(FILE *fp, char *cName, int dimension, double stepsize)
{
...
void PC::fnWritePar2File(FILE *fp, char *cName, int dimension, double stepsize)
{
...
void   PCm::fnWritePar2File(FILE *fp, char *cName, int dimension, double stepsize)
{
        //char *str = new char[80];
...
void FreeBox::fnWritePar2File(FILE *fp, char *cName, int dimension, double stepsize)
{
        //char *str = new char[80];
...
void tBLM::fnWritePar2File(FILE *fp, char *cName, int dimension, double stepsize)
{
        //char *str = new char[80];
...
void ssBLM::fnWritePar2File(FILE *fp, char *cName, int dimension, double stepsize)
{
        //char *str = new char[80];
...
void tBLM_binary::fnWritePar2File(FILE *fp, char *cName, int dimension, double stepsize)
{
        //char *str = new char[80];
