...
BLM_quaternary::BLM_quaternary(){
	...
	methyl2	   = new	Box2Err();
	lipid2	   = new Box2Err();
	headgroup2 = new Box2Err();                                                          //PC head group
...
void BLM_quaternary::fnInit(double va1, double na1, double vm1, double nm1, double vh1, double nh1, double lh1, double va2, double na2, double vm2, double nm2, double vh2, double nh2, double lh2, double va3, double na3, double vm3, double nm3, double vh3, double nh3, double lh3, double vc, double nc){
    ...
    volacyllipid_2=va2;
    nslacyllipid_2=na2;
    volmethyllipid_2=vm2;
    nslmethyllipid_2=nm2;
    volacyllipid_3=va3;
    nslacyllipid_3=na3;
    volmethyllipid_3=vm3;
    nslmethyllipid_3=nm3;
    
    volchol=vc;
    nslchol=nc;

    headgroup1->vol=vh1;
    headgroup1_2->vol=vh2;
    headgroup1_3->vol=vh3;
    headgroup2->vol=vh1;
    headgroup2_2->vol=vh2;
    headgroup2_3->vol=vh3;
    headgroup1->nSL=nh1;
    headgroup1_2->nSL=nh2;
    headgroup1_3->nSL=nh3;
    headgroup2->nSL=nh1;
    headgroup2_2->nSL=nh2;
    headgroup2_3->nSL=nh3;
    headgroup1->l=lh1;
    headgroup1_2->l=lh2;
    headgroup1_3->l=lh3;
    headgroup2->l=lh1;
...
void BLM_quaternary::fnAdjustParameters(){
    ...
    defect_headgroup->nSL=defectratio*(headgroup2->fnGetnSL(bulknsld)*headgroup2->nf+headgroup2_2->fnGetnSL(bulknsld)*headgroup2_2->nf+headgroup2_3->fnGetnSL(bulknsld)*headgroup2_3->nf);
...
double BLM_quaternary::fnGetCenter() {
    return (methyl1->z + 0.5 * methyl1->l);
};
...
double BLM_quaternary::fnGetnSLD(double dz) {
    ...
    if (sum==0) {return 0;}
        ...
        return (
                headgroup1->fnGetnSLD(dz,bulknsld)*headgroup1area+
                ...
                headgroup2->fnGetnSLD(dz,bulknsld)*headgroup2area+
