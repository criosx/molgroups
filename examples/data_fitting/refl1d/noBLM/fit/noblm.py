...
n_surfasil = Parameter(name='surfasil numfrac', value=5.).range(0.1, 10)
sigma = Parameter(name='surfasil roughness', value=5).range(2, 3)
global_rough = Parameter(name ='global roughness', value=5).range(2, 3)

# Define bilayer object
substrate = mol.Box2Err(dz=10, dsigma1=0, dsigma2=2, dlength=40, dvolume=2000, dnSL=0, dnumberfraction=1, name='siox')
surfasil = mol.Box2Err(dz=50, dsigma1=2, dsigma2=2, dlength=60, dvolume=100, dnSL=5e-6*100, dnumberfraction=1, name='surfasil')
...
mollayer = FunctionalProfile(dimension*stepsize, 0, profile=bilayer, sigma=sigma, bulknsld=d2o.rho,
                             global_rough=global_rough, rho_substrate=siox.rho, l_surfasil=l_surfasil,
                             n_surfasil=n_surfasil)
