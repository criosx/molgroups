...
void ssBLM::fnSet(double _sigma, double _global_rough, double _rho_substrate, double _rho_siox, double _l_siox, double _l_submembrane, double _l_lipid1, double _l_lipid2, double _vf_bilayer, double _hc_substitution_1, double _hc_substitution_2){
...
double Hermite::fnGetSplineArea(double dz, double dp[], double dh[]) {
    ...
    //printf("fnGetArea z %e dp[0] %e dp[5] %e vf[0] %e vf[5] %e \n", dz, dp[0], dp[5], vf[0], vf[5]);
...
{    
    return fnGetSplineArea(dz, dp, vf)*normarea*nf;
};
...
tBLM_HC18_POPC_POPE_CHOL::tBLM_HC18_POPC_POPE_CHOL()
{
	...
	headgroup1_2->vol=262;                //PG volume and length are estimates
