...
background0 = Parameter(name='background0', value= 1.0).range( 0.0, 2.0)
background1 = Parameter(name='background1', value= 1.0).range( 0.0, 2.0)
sld_solvent0 = Parameter(name='sld_solvent0', value= 2.8886406121829413).range( 2.8686406121829413, 2.9086406121829413)
sld_solvent1 = Parameter(name='sld_solvent1', value= 2.965258272492494).range( 2.945258272492494, 2.985258272492494)

model0.scale.range( 0.0001, 0.005)
model0.background = background0
model0.sld.range( 1.0, 4.0)
model0.sld_solvent = sld_solvent0
model0.radius.range( 40.0, 90.0)
model0.radius_pd.range( 0.1, 0.5)
