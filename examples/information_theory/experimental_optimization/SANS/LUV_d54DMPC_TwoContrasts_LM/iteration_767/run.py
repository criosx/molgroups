...
M0.frac_deut.range( 0.6300448325482164, 0.6500448325482164)
...
sld_solvent0 = sld_core0 = Parameter(name='sld_solvent0', value= 2.208196372375541).range( 2.108196372375541, 2.308196372375541)
sld_solvent1 = sld_core1 = Parameter(name='sld_solvent1', value= 6.205530310452379).range( 6.105530310452379, 6.3055303104523786)
