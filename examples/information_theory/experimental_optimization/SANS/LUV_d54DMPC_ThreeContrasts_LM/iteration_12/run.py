...
M0.l_lipid.range( 8.0, 12.0)
M0.sigma.range( 1.0, 5.0)
M0.frac_deut.range( 0.015870009577928834, 0.03587000957792885)

# PARAMETER RANGES (ONLY THOSE PARAMETERS ARE FITTED)
background0 = Parameter(name='background0', value= 0.75).range( 0.0, 1.5)
background1 = Parameter(name='background1', value= 0.75).range( 0.0, 1.5)
background2 = Parameter(name='background2', value= 0.75).range( 0.0, 1.5)
sld_solvent0 = sld_core0 = Parameter(name='sld_solvent0', value= 1.7830179188745303).range( 1.6830179188745302, 1.8830179188745304)
sld_solvent1 = sld_core1 = Parameter(name='sld_solvent1', value= 6.419380192746762).range( 6.319380192746762, 6.519380192746762)
sld_solvent2 = sld_core2 = Parameter(name='sld_solvent2', value= 0.8385291791323921).range( 0.738529179132392, 0.9385291791323922)
scale0 = Parameter(name='scale0', value= 10.0).range( 5.0, 15.0)
scale1 = scale2 = scale0
vf0 = Parameter(name='vf0', value= 0.055).range( 0.01, 0.1)
